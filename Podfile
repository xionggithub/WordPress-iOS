...
target 'WordPress' do
    ...
    #pod 'WordPressAuthenticator', '~> 1.17.0-beta.6'
    # While in PR
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'issue/283-unified-site-address-ff'
